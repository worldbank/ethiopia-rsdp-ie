...
p_gc1996_urban <- make_gc_figure(gc1996_df, "Baseline")
p_gc2016_urban <- make_gc_figure(gc2016_df, "Endline")

p_gc_urban <- ggarrange(p_gc1996_urban, p_gc2016_urban, nrow = 1) %>%
...
p_gc1996_crop <- make_gc_figure(gc1996_df, "Baseline")
p_gc2016_crop <- make_gc_figure(gc2016_df, "Endline")

p_gc_crop <- ggarrange(p_gc1996_crop, p_gc2016_crop, nrow = 1) %>%
