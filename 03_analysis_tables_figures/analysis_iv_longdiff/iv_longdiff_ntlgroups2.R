...
for(rsdp_type in c("rsdp123")){
  ...
  iv_cd_dmspols_ihs_basentl_g     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_cd_globcover_urban_basentl_g <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_cd_globcover_crop_basentl_g  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  ...
  iv_cd_dmspols_ihs_basentl_k     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_cd_globcover_urban_basentl_k <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_cd_globcover_crop_basentl_k  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc + near_mst_lcXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  ...
  iv_ld_dmspols_ihs_basentl_g     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_ld_globcover_urban_basentl_g <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_ld_globcover_crop_basentl_g  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  ...
  iv_ld_dmspols_ihs_basentl_k     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_ld_globcover_urban_basentl_k <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_ld_globcover_crop_basentl_k  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc + near_mst_eucXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  ...
  iv_cd_dmspols_ihs_basentl_regions_g     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_cd_globcover_urban_basentl_regions_g <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_cd_globcover_crop_basentl_regions_g  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  ...
  iv_cd_dmspols_ihs_basentl_regions_k     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_cd_globcover_urban_basentl_regions_k <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_cd_globcover_crop_basentl_regions_k  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_lc_region + near_mst_lc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  ...
  iv_ld_dmspols_ihs_basentl_regions_g     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_ld_globcover_urban_basentl_regions_g <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  iv_ld_globcover_crop_basentl_regions_g  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_grid)
  ...
  iv_ld_dmspols_ihs_basentl_regions_k     <- as.formula(paste("dv_dmspols ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_ld_globcover_urban_basentl_regions_k <- as.formula(paste("dv_gcurban ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
  iv_ld_globcover_crop_basentl_regions_k  <- as.formula(paste("dv_gccrop  ~ distance_rsdp123_targettedlocs_log | 0 | (near_rsdp123|near_rsdp123Xwor_ntlgroup_2bin ~ near_mst_euc_region + near_mst_euc_regionXwor_ntlgroup_2bin) | ", "cluster_var")) %>% felm(data = df_kebele)
